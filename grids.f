...
C        WRITE(*,*) LVAL(I,IPARE)
       ...
       IF (SUM(NPATCH).EQ.NPALEV) STOP 'NPALEV too small'
...
!$OMP+            SCHEDULE(DYNAMIC)
     ...
     &                  n1,n2,n3
          ...
          ELSE
           ...
           CALL ARGSORT(NBASPART,RADPART,INDICE)
           DO II=1,NBASPART
...
!$OMP PARALLEL DO SHARED(LOW1,LOW2,NVECI,VECINO,PATCHX,PATCHY,PATCHZ,
!$OMP+                   SOLAP,PATCHRX,PATCHRY,PATCHRZ,DXPA,DYPA,DZPA,
!$OMP+                   RXFIX,RYFIX,RZFIX,PATCHNX,PATCHNY,PATCHNZ),
!$OMP+            PRIVATE(I,I2,L1,L2,L3,NV,RX1,RY1,RZ1,IG1,JG1,KG1,IG2,
!$OMP+                    JG2,KG2,K,N1,N2,N3,NN1,NN2,NN3,RXX1,RYY1,RZZ1,
!$OMP+                    IG3,JG3,KG3,IG4,JG4,KG4),
!$OMP+            DEFAULT(NONE)
       DO I=LOW1,LOW2
         I2=I-LOW1+1
...
*********************************************************************
     ...
     &            ' (for faster search)'
       ...
       CALL ARGSORT(N_DM,RXPA(1:N_DM),INDICES)
